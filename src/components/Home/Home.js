    ...
    return (
        <div className='lg:px-24 mx-5 text-start'>
            <div>
                ...
                <h2 className='text-4xl my-5 font-bold uppercase'>I'm <span className='text-transparent bg-clip-text bg-gradient-to-br from-[#13F26D] to-[#0092A4] capitalize'>Sheikh Muhammad Riyadh Hasan</span></h2>
