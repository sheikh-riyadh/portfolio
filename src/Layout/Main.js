                ...
                <div className="drawer-side">
                    ...
                    <ul className="menu p-11 w-80 bg-[#0A1413] text-base-content">
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <div className='text-start text-xl flex items-center gap-3'>
                                <a download href='https://drive.google.com/file/d/1rQkKdhUYwy9BQcBN6zKeULNtM6MI21S0/view?usp=sharing' className='btn bg-gradient-to-r from-[#13F26D] to-[#0092A4] border-0
